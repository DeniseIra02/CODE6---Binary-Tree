...
class BinarySearchTreeNode:
    ...
    def delete(self, val):
        if val < self.data: #check if the value is less than the current node
            ...
            if self.left is None and self.right is None: #check if both subtree is none
                return None
...
if __name__ == '__main__':
    print()
    fullname_letters = ["D", "E", "N", "I", "S", "E", "I", "R", "A", "J", "U", "B", "I", "L", "O"]
    fullname_letters_tree = build_tree(fullname_letters)
    
    #inorder, preorder, postorder
    print()
    print("==================================================================================================================")
    print()
    print("Alphabetical Order / In order Traversal:", fullname_letters_tree.in_order_traversal()) 
    print()
    print()
    print("Pre order Traversal:", fullname_letters_tree.pre_order_traversal()) 
    print()
    print()
    print("Post order Traversal:", fullname_letters_tree.post_order_traversal()) 
    print()
    print("==================================================================================================================")
    
    #search 
    print()
    print("Does letter R is on the list?", fullname_letters_tree.search("R"))
    print()
    print("Does letter Z is on the list?", fullname_letters_tree.search("Z"))  
    print()
    print("==================================================================================================================")
    
    #Delete
    print()
    fullname_letters_tree.delete("J")
    print("After deleting the element J (In order):", fullname_letters_tree.in_order_traversal())
    print()
    print("After deleting the element J (Pre order):", fullname_letters_tree.pre_order_traversal())
    print()
    print("After deleting the element J (Post order):", fullname_letters_tree.post_order_traversal())
    print()